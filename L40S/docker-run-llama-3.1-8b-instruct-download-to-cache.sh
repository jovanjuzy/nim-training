...
# tensorrt_llm-l40s-bf16-tp2-latency
docker run -it --rm \
  ...
  nvcr.io/nim/meta/llama-3.1-8b-instruct:1.1.2 \
  bash -c "
download-to-cache -p 0494aafce0df9eeaea49bbca6b25fc3013d0e8a752ebcf191a2ddeaab19481ee
"

# tensorrt_llm-l40s-bf16-tp1-throughput
docker run -it --rm \
  -v "$HOME/.cache/nim:/opt/nim/.cache:rw" \
  -u $(id -u) \
  -e NGC_API_KEY \
  nvcr.io/nim/meta/llama-3.1-8b-instruct:1.1.2 \
  bash -c "
download-to-cache -p 3807be802a8ab1d999bf280c96dcd8cf77ac44c0a4d72edb9083f0abb89b6a19
"
...
docker run -it --rm \
  ...
  nvcr.io/nim/meta/llama-3.1-8b-instruct:1.1.2 \
  bash -c "
download-to-cache -p 6a3ba475d3215ca28f1a8c8886ab4a56b5626d1c98adbfe751025e8ff3d9886d
"
...
docker run -it --rm \
  ...
  nvcr.io/nim/meta/llama-3.1-8b-instruct:1.1.2 \
  bash -c "
download-to-cache -p 3bb4e8fe78e5037b05dd618cebb1053347325ad6a1e709e0eb18bb8558362ac5
"
